...
export const ROUTE_PERMISSION_RULES: Array<{ prefix: string; permission: string; exact?: boolean }> = [
  ...
  { prefix: '/admin/content/ai-music-video-generator', permission: 'marketing.view' },
  { prefix: '/admin/ai-music-video/projects', permission: 'aimv.queue.view' },
  { prefix: '/admin/mv-product-center/content', permission: 'aimv.queue.view' },
  ...
  { prefix: '/admin/aimv-generator/hot-music', permission: 'aimv.content.view' },
  { prefix: '/admin/aimv-generator/creation-styles', permission: 'aimv.content.view' },
  { prefix: '/admin/aimv-generator/assets', permission: 'aimv.content.view' },
  { prefix: '/admin/aimv-generator/templates', permission: 'aimv.content.view' },
  { prefix: '/admin/aimv-generator/capacity', permission: 'aimv.routing.view' },
  { prefix: '/admin/aimv-generator/queue', permission: 'aimv.queue.view' },
  { prefix: '/admin/aimv-generator/retention', permission: 'aimv.queue.view' },
  { prefix: '/admin/aimv-generator/pricing', permission: 'aimv.pricing.view' },
  { prefix: '/admin/aimv-generator', permission: 'aimv.settings.view' },
  { prefix: '/admin/inspiration/products', permission: 'inspiration.content.view' },
  { prefix: '/admin/inspiration/forms', permission: 'inspiration.content.view' },
  { prefix: '/admin/inspiration/models', permission: 'inspiration.models.view' },
  { prefix: '/admin/inspiration/tasks', permission: 'inspiration.tasks.view' },
  { prefix: '/admin/inspiration/created', permission: 'inspiration.tasks.view' },
  { prefix: '/admin/inspiration', permission: 'inspiration.content.view' },
