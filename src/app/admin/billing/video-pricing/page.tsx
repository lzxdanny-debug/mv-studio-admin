            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-28 px-3 py-2 text-2xl font-bold text-slate-900 border border-slate-200 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
                ...
                <button
                  ...
                  className="ml-1 inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 disabled:opacity-40 text-white text-xs font-medium"
                >
  ...
  return (
    <tr className={cn(isNew && 'bg-purple-50/40')}>
      ...
      <td className="px-3 py-2 text-center">
        <input type="checkbox" checked={local.enabled} onChange={(e) => patch({ enabled: e.target.checked })} className="accent-purple-600" />
      </td>
      ...
      <td className="px-3 py-2 text-right whitespace-nowrap">
        ...
        <button onClick={() => onSave(local)} disabled={saving} className="ml-1 px-2.5 py-1 text-xs rounded bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white inline-flex items-center gap-1">
