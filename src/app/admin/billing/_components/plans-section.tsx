...
function PlanCard({
  ...
  return (
    <div className={cn('bg-white border rounded-2xl p-4', isNew ? 'border-blue-300' : 'border-slate-200')}>
      ...
      <div className="flex items-center justify-end gap-2 mt-3 pt-3 border-t border-slate-100">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-medium"
        >
          {saving ? (
