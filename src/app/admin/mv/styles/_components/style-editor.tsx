        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[80px] text-xs font-mono px-3 py-2 rounded-lg border border-slate-200 focus:border-purple-400 focus:ring-1 focus:ring-purple-200 outline-none resize-y"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[60px] text-xs px-3 py-2 rounded-lg border border-slate-200 focus:border-purple-400 focus:ring-1 focus:ring-purple-200 outline-none resize-y"
              placeholder="风格说明…"
            />
          </div>
