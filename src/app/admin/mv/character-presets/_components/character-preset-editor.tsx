          ...
          <div className="inline-flex bg-slate-100 rounded-xl p-1">
            <button
              ...
              className={cn(
                ...
                tab === 'ai' ? 'bg-white shadow-sm text-blue-700' : 'text-slate-500',
              )}
            >
            ...
            <button
              ...
              className={cn(
                'px-3 py-1.5 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-all',
                tab === 'upload' ? 'bg-white shadow-sm text-blue-700' : 'text-slate-500',
              )}
            >
                ...
                {SUBJECT_OPTIONS.map((opt) => (
                  ...
                  >
                    <div
                      className={cn(
                        'font-medium',
                        subjectType === opt.value ? 'text-blue-700' : 'text-slate-700',
                      )}
                    >
                      {opt.label}
                    </div>
            ...
            <div className="space-y-3 pt-2 border-t border-slate-100">
              ...
              >
                <textarea
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 font-mono leading-relaxed"
                />
              </FieldRow>
        ...
        <div className="px-5 py-3 border-t border-slate-200 flex items-center justify-end gap-2 flex-shrink-0 bg-slate-50">
          ...
          {mode === 'create' && tab === 'ai' && (
            <button
              ...
              className="px-4 py-1.5 rounded-xl text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white disabled:opacity-50 flex items-center gap-1.5"
            >
  ...
  return (
    <div className="flex items-start gap-3">
      <label className="flex-1 cursor-pointer">
        <div className="border-2 border-dashed border-slate-200 hover:border-blue-300 rounded-xl px-4 py-6 text-center transition-colors">
